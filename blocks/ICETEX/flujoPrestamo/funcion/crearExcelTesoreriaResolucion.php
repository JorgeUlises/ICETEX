...
->setDescription("Archivo resultado de cargar una resoluci髇 a estudiantes en el proceso de ICETEX")
->setKeywords("estudiantes, ICETEX, cedulas, OAS")
->setCategory("ICETEX");


$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'C茅dula');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1', 'Nombre');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1', 'C贸digo');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'C贸digo resoluci贸n');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'Valor matricula');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', 'Valor resoluci贸n');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', 'Valor Pago estudiante');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', 'Valor a devolverle a estudiante');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', 'Valor que el estudiante debe pagar');
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', 'Matricula diferida');
...
foreach ($lista as $li){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$i, $li['valorPagoEstudiante']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$i, $li['valorPago']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$i, $li['valorDebePago']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$i, $li['diferido']);
