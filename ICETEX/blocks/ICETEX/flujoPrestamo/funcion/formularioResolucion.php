...
echo "<h3>".utf8_encode($this->lenguaje->getCadena("tituloFormularioResolucion"))."</h3>";
echo '</div>';
...
echo "<tr><td><b>".utf8_encode($this->lenguaje->getCadena("resolucion"))."</b>:</td>";
...
echo "<tr><td><b>".utf8_encode($this->lenguaje->getCadena("valorTotal"))."</b>:</td>";
...
echo "<tr><td><b>".utf8_encode($this->lenguaje->getCadena("periodo"))."</b>:</td>";
...
echo "</tr>";
echo "</table>";
//echo "<br><div style =\"font-style:italic;text-align: center;\">".$this->lenguaje->getCadena("notaExcelResolucion");
$textoAdd= $this->lenguaje->getCadena("notaExcelResolucion");

$rutaURL = $this->miConfigurador->getVariableConfiguracion ( "host" ) . $this->miConfigurador->getVariableConfiguracion ( "site" ).'/blocks';
$rutaURL .='/'.$_REQUEST["bloqueGrupo"].'/'.$_REQUEST["bloqueNombre"].'/'.'uploads/PLANTILLA_RESOLUCION.xls';

$textoAdd.= '<br><a href="'.$rutaURL.'" >'.$this->lenguaje->getCadena("plantillaExcel").' </a> ';


$this->miMensaje->addMensaje("10",":".$textoAdd,"information");
echo $this->miMensaje->getLastMensaje();


//echo "</div>";
echo "<p style=\"text-align: center;padding: 5px;\"><b>".utf8_encode($this->lenguaje->getCadena("documentoExcel"))."</b>:";
...
//echo "<div style =\"font-style:italic;text-align: center;\">".utf8_encode($this->lenguaje->getCadena("notaPDFResolucion"))."</div>";
$this->miMensaje->addMensaje("11","notaPDFResolucion","information");
echo $this->miMensaje->getLastMensaje();


echo "<p style=\"text-align: center;padding: 5px;\"><b>".utf8_encode($this->lenguaje->getCadena("documentoResolucion"))."</b>:";
...
echo '<div style="text-align: center;padding: 10px;">';
echo '<input type="button" onclick="enviarResolucion();" width="30px" id="consultarUsuario" value= "'.utf8_encode($this->lenguaje->getCadena("enviarResolucion")).'">';
echo '</div>';
echo "</form>";
