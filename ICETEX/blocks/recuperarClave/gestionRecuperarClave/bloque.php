...
if (class_exists ( 'BloquegestionRecuperarClave' ) === false) {
	class BloquegestionRecuperarClave implements Bloque {
		var $nombreBloque;
		var $miFuncion;
		var $miSql;
		var $miConfigurador;
...
// la variable $_REQUEST["bloqueNombre"] debe definirse en registrarAjax.php
